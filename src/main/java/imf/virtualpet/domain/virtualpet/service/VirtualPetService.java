package imf.virtualpet.domain.virtualpet.service;
...
import imf.virtualpet.domain.virtualpet.repository.VirtualPetRepository;
import imf.virtualpet.domain.virtualpet.util.VirtualPetMapper;
